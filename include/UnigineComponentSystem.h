...
protected:
	UNIGINE_API bool is_type_name(const char *name) const;
	virtual String get_value_as_string() const { return String::null; }
...
protected:
	virtual String get_value_as_string() const override { return String::itoa(value); }
	int value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::ftoa(value); }
	float value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::dtoa(value); }
	double value;
};
...
protected:
	virtual String get_value_as_string() const override { return value; }
...
protected:
	virtual String get_value_as_string() const override { return String::format("%f %f", value.x, value.y); }
	Math::vec2 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%f %f %f", value.x, value.y, value.z); }
	Math::vec3 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%f %f %f %f", value.x, value.y, value.z, value.w); }
	Math::vec4 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%lf %lf", value.x, value.y); }
	Math::dvec2 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%lf %lf %lf", value.x, value.y, value.z); }
	Math::dvec3 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%lf %lf %lf %lf", value.x, value.y, value.z, value.w); }
	Math::dvec4 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%d %d", value.x, value.y); }
	Math::ivec2 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%d %d %d", value.x, value.y, value.z); }
	Math::ivec3 value;
};
...
protected:
	virtual String get_value_as_string() const override { return String::format("%d %d %d %d", value.x, value.y, value.z, value.w); }
	Math::ivec4 value;
};
...
protected:
	virtual String get_value_as_string() const override { return value_guid.makeString(); }
	PropertyPtr value;
	UGUID value_guid;
};
...
protected:
	virtual String get_value_as_string() const override { return String::itoa(value_id); }
	NodePtr value;
	int value_id;
};
...
public:
	...
	UNIGINE_API ComponentVariableCurve2d(PropertyWrapper *component, const char *name,
		const char *title = nullptr, const char *tooltip = nullptr, const char *group = nullptr, const char *args = nullptr)
		: ComponentVariable(component, name, Property::PARAMETER_CURVE2D, title, tooltip, group, args) {}
	ComponentVariableCurve2d(PropertyWrapper* component, const char *name, const Curve2dPtr &default_value,
		const char *title = nullptr, const char *tooltip = nullptr, const char *group = nullptr, const char *args = nullptr)
		: ComponentVariable(component, name, Property::PARAMETER_CURVE2D, title, tooltip, group, args)
		, value(default_value) {}
	...
	UNIGINE_API ComponentVariableCurve2d &operator=(const Curve2dPtr &value);
	UNIGINE_API operator Curve2dPtr() const;
	UNIGINE_API Curve2dPtr get() const;
	UNIGINE_API Curve2d *operator->();
	UNIGINE_INLINE int isEmpty() const { return get().get() == nullptr; }
	virtual int nullCheck() const override { return isEmpty(); }

protected:
	virtual String get_value_as_string() const override { return String(""); }
	mutable Curve2dPtr value{Curve2d::create()};
};
