...
UNIGINE_INLINE bool compare(const mat4 &m0, const mat4 &m1)
{
...
UNIGINE_INLINE bool compare(const mat4 &m0, const mat4 &m1, float epsilon)
{
...
UNIGINE_INLINE bool operator==(const mat4 &m0, const mat4 &m1) { return compare(m0, m1); }
...
UNIGINE_INLINE mat4 &inverse(mat4 &ret, const mat4 &m)
{
		...
		temp = _MM_SWIZZLE(temp, Y, X, W, Z);
		res_0 = _mm_mad_ps(row_3, temp, res_0);
		...
		res_0 = _mm_mad_ps(row_2, temp, res_0);
		...
		temp = _MM_SWIZZLE(temp, Y, X, W, Z);
		res_2 = _mm_mad_ps(row_3, temp, res_2);
...
{
	mat4 ret = projection;
	ret.m20 = 0.5f * (projection.m20 + projection.m30);
	ret.m21 = 0.5f * (projection.m21 + projection.m31);
	ret.m22 = 0.5f * (projection.m22 + projection.m32);
	ret.m23 = 0.5f * (projection.m23 + projection.m33);
	return ret;
}
...
{
	mat4 ret = projection;
	ret.m20 = 0.5f * (projection.m30 - projection.m20);
	ret.m21 = 0.5f * (projection.m31 - projection.m21);
	ret.m22 = 0.5f * (projection.m32 - projection.m22);
	ret.m23 = 0.5f * (projection.m33 - projection.m23);
	return ret;
}
